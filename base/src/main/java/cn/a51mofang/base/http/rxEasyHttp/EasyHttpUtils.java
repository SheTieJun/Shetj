package cn.a51mofang.base.http.rxEasyHttp;
...
import cn.a51mofang.base.view.LoadingDialog;

/**
 * Created by shetj on 2017/10/16.
 * 2017年10月19日10:46:14
 */
...
public class EasyHttpUtils {
	...
	private static void initConfig(boolean isDebug) {
		//全局设置请求头
...
//						.addCommonHeaders(new HttpHeaders("Authorization", "Bearer " + TokenManager.getInstance().getToken()))
						...
						.setRetryDelay(400)//每次延时500ms重试
						//可以全局统一设置超时重试间隔叠加时间,默认为0ms不叠加
						.setRetryIncreaseDelay(400)//每次延时叠加500ms
