...
import me.shetj.rxhttp.cache.converter.SerializableDiskConverter;
import me.shetj.rxhttp.cache.model.CacheMode;
import me.shetj.rxhttp.cookie.CookieManger;
import me.shetj.rxhttp.https.HttpsUtils;
import me.shetj.rxhttp.interceptor.HttpLoggingInterceptor;
import me.shetj.rxhttp.model.HttpHeaders;
import me.shetj.rxhttp.model.HttpParams;
import me.shetj.rxhttp.request.CustomRequest;
import me.shetj.rxhttp.request.DeleteRequest;
import me.shetj.rxhttp.request.DownloadRequest;
import me.shetj.rxhttp.request.GetRequest;
import me.shetj.rxhttp.request.PostRequest;
import me.shetj.rxhttp.request.PutRequest;
...
public final class RxHttp {
     ...
     * 调试模式,默认打开所有的异常调试
     */
    public RxHttp debug(String tag) {
        debug(tag, true);
        return this;
    }
     ...
     * 全局设置代理
     */
    public RxHttp setOkproxy(Proxy proxy) {
     ...
     * 全局设置请求的连接池
     */
    public RxHttp setOkconnectionPool(ConnectionPool connectionPool) {
     ...
     */
    public RxHttp setOkclient(OkHttpClient client) {
