...
/**
 * <b>@packageName：</b> com.shetj.diyalbume.executors<br>
 * <b>@author：</b> shetj<br>
 * <b>@createTime：</b> 2018/7/18 0018<br>
 * <b>@company：</b><br>
 * <b>@email：</b> 375105540@qq.com<br>
 * <b>@describe</b><br>
 */
public class ExecutorsPool  extends ThreadPoolExecutor {
	 ...
	 */
	public ExecutorsPool(boolean fifo) {
	 ...
	 * @param fifo     优先级相同时, 等待队列的是否优先执行先加入的任务.
	 */
	public ExecutorsPool(int poolSize, boolean fifo) {
	...
	public ExecutorsPool(int corePoolSize, int maximumPoolSize, long keepAliveTime, TimeUnit unit, BlockingQueue<Runnable> workQueue, ThreadFactory threadFactory) {
