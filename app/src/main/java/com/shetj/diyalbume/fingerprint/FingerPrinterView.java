...
public class FingerPrinterView extends View{
  ...
  private void initBitmap() {
    mFingerRed =((BitmapDrawable) ArmsUtils.getDrawablebyResource(getContext(),R.drawable.finger_red)).getBitmap();
    mFingerGreen = ((BitmapDrawable) ArmsUtils.getDrawablebyResource(getContext(),R.drawable.finger_green)).getBitmap();
    mFingerGrey = ((BitmapDrawable) ArmsUtils.getDrawablebyResource(getContext(),R.drawable.finger_grey)).getBitmap();
