...
public class RadarImageView extends CircleImageView {
    ...
    public RadarImageView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        getAttrs(context, attrs);
        init();
    }

    public RadarImageView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
...
//            invalidate();
    ...
    private static class Raindrop {
        ...
        public int changeAlpha() {
            return RadarImageView.changeAlpha(color, (int) alpha);
        }
