...
class WaveView@JvmOverloads constructor(
    ...
    public var mWaveColor = Color.RED

    public var mRadiusMin = 140f
    public var mRadiusMax = 270f
    public var mWaveInterval = 20f
    //用每次扩散半径增加的值作为速度参数
    public var speed = 20f

    private val mWaveList = ArrayList<Float>()

    private val timeline = object: CountDownTimer(300000,50){
    ...
    private fun initWave(waveList: ArrayList<Float>){
        val waveNum = ((mRadiusMax-mRadiusMin)/mWaveInterval).toInt() +1
        for (i in 1..waveNum){
