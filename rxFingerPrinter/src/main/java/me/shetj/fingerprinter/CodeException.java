...
public class CodeException {
    ...
    @IntDef({SYSTEM_API_ERROR, PERMISSION_DENIED_ERROE,
            HARDWARE_MISSIING_ERROR, KEYGUARDSECURE_MISSIING_ERROR,
            NO_FINGERPRINTERS_ENROOLED_ERROR,FINGERPRINTERS_FAILED_ERROR})
